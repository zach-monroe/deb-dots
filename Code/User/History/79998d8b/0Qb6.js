window.addEventListener('load', () => {
    ...
    const api_key = 'fb3112e46855872a13349c0a9f47e7a3'; //Example (put your API key here)
    const country = 'US' //Example (change this to your country)
    const location = 'Tuckerton'; //Example (change this to your city)
  ...
  fetch(url)
        ...
        .then(data => {
            ...
            weather_temp.innerHTML = `<span style="color: #6d7072;">Feels like </span>${ftemp}°F`;
