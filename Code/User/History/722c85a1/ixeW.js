            ...
            <div class="columns">
                <div class="column">
                    <ul class="bookmark-list">
                        <li>
                            <span class="folder">Programming</span>
                            <ul class="sub-list">
                                <li><a href="https:/www.github.com">Git</a></li>
                                <li><a href="https:/www.udemy.com/">Udemy</a></li>
                                <li><a href="https:/www.leetcode.com">Leet</a></li>
                                <li><a href="https:/developer.mozilla.org/en-US/">Mdn</a></li>
                            </ul>
                        </li>
                        <br>
                        <li>
                            <span class="folder">Fun</span>
                            <ul class="sub-list">
                                <li><a href="https:/www.reddit.com">Reddit</a></li>
                                <li><a href="https:/www.hulu.com">Hulu</a></li>
                                <li><a href="https:/www.crunchyroll.com/">Crunchy</a></li>
                ...
                <div class="column">
                    <ul class="bookmark-list">
                        ...
                        <br>
                        <li>
                            <span class="folder">Shopping</span>
                            <ul class="sub-list">
                                <li><a href="https:/www.amazon.com">Amazon</a></li>
                                <li><a href="https:/www.etsy.com">Etsy</a></li>
                                <li><a href="https:/www.etsy.com">Ebay</a></li>
