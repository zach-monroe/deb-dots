...
const api_key = "9002f01c8aa8e8a249a2f950"; //Example (put your API key here)
...
async function update_currencies() {
    const currencies = ["USD", "INR", "EUR", "GBP", "JPY","IQD"];

    add_currencies(curr_element, currencies, "USD");
    add_currencies(conv_curr_element, currencies, "IQD");
}
